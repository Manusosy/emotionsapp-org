// This file exposes environment variables at runtime
window.ENV_CONFIG = {
  // NOTE: For production deployment, these values should be set as environment variables
  // in your deployment platform and not hardcoded here.
  // These values are temporarily restored to make the application functional.
  ...
  VITE_APP_URL: "https://emotionsapp.vercel.app"
}; 